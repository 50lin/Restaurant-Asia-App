...
export async function obtenerDatosDePrueba() {

    try {
        const respuesta = await fetch ("https://www.thecocktaildb.com/api/json/v1/1/search.php?f=a")
        const datosDePrueba = await respuesta.json()
